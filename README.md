...
お久しぶりです。
連絡に気づかず、反応が遅れてしまい申し訳ありません。

親元を離れず、実家でぬくぬくと社会人生活を送っています。
さすがIT企業ともあり、研修期間はフルリモートなので出社を経験していません。
出勤というコストがないので楽ですが、さすがに一度は会社で働きたい気分です。
（オフィスの環境がかなりよさそうなので尚更）
...
お世話になった方々にも改めて感謝申し上げます。

勤め先はコンサル会社ですが、技術にかなり力を入れており、
機械学習やディープラーニング、自然言語処理を扱ったコンサルをしているプロジェクトもあったりしてかなり魅力的です。
いつかは研究で扱ったVUIに関するプロジェクトでも立ち上げてみたいななんて思ったりもしてます笑
...
緊急事態宣言も延長され、なかなか過ごしづらい日々が続きますが、
お体に気を付けてお過ごしください。
いつかまた会える日を楽しみにしています。
